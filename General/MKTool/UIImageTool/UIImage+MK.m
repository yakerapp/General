...
- (UIImage *)applyLightEffect
{
    ...
    return [self applyBlurWithRadius:55                                                                                                    tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
- (UIImage *)applyLightEffect1
{
    UIColor *tintColor = [UIColor colorWithWhite:1.0 alpha:0.1];
    return [self applyBlurWithRadius:38                                                                                                    tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
